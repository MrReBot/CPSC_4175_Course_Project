...
class Ui_Input_window_frm(object):
    def setupUi(self, Input_window_frm):
        ...
        self.InputFilePath_lineEdit.setGeometry(QtCore.QRect(60, 360, 541, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.Clear_btn.setGeometry(QtCore.QRect(60, 410, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.Continue_btn.setGeometry(QtCore.QRect(430, 410, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
