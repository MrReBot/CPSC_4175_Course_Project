...
class Ui_Output_window_frm(object):
    def setupUi(self, Output_window_frm):
        ...
        self.ViewScheduler_lbl.setGeometry(QtCore.QRect(180, 10, 321, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.Print_btn.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.CheckSchedule_btn.setGeometry(QtCore.QRect(380, 350, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.SchedulerOutput_tbl.setGeometry(QtCore.QRect(50, 40, 551, 301))
        ...
        self.GenerateSchedule_btn.setGeometry(QtCore.QRect(50, 350, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
